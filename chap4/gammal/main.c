		  ...
		  unsigned char *result)
{
  ...
  unsigned long long carry_bit = ((unsigned long long int)(unsigned long int)a_x_b_mid + (unsigned long long int)(unsigned long int)b_x_a_mid + (a_x_b_lo >> 32)) >> 32;

  unsigned long long int rest = a_x_b_hi + (a_x_b_mid >> 32) + (b_x_a_mid >> 32) + carry_bit;
  result = (unsigned long int)rest;
}
