...
{	
	...
	while(true)
	{
		...
		//isAcOn = (inputRegister >> 4) & 0x1; // Assignment
		...
		temperatureDesired = 14.5 + (((inputRegister >> 5) & 0x1F) * 0.5); // Assignment
		...
		temperatureMeasured_fractional &= 0x07; // Assignment
		...
		//outputRegister |= (0x00000003 << 2); // Assignment
		//outputRegister |= (0x00000003 << 2);
