...
int main(int argc, char **argv)
{
  ...
  while (true)
      ...
      if (timerValueSeconds > nextBlinkAction)
	{
      ...
      switch(Light_State)
	{
	case NO_BATTERY:  /* Case 1 */
	  if(left_button_pushed)
	    Light_State = BATTERY_INSTALLED;
	  break;
	  
	case BATTERY_INSTALLED: /* Case 2 */
	  if(left_button_pushed)
	...
	case BATTERY_REMOVED: /* Case 12 */			
	  break;
	  
	default:  /* Default case with "NO_BATTERY" */
	  Light_State = NO_BATTERY;
	}
